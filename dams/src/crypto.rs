...
pub struct Secret {
    ...
    material: Bytes,
    /// Context for the secret. This might include ownership details (like a
    /// [`UserId`]), generation details (like the scheme and parameter
    /// selections used to create it), or other relevant context.
    context: Context,
}
...
enum Context {
    ...
    MasterKey,
    /// Lock Keeper storage key generated uniformly at random.
    StorageKey,
