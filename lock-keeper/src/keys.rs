...
/// enforced by the Lock Keeper key server. When a user-set policy is triggered,
/// the key server can seek additional authentication or confirmation directly
...
///
/// Assumption: This module will be used with a Lock Keeper instantiation that
/// has a fixed set of asset fiduciaries, configured at system setup. The asset
