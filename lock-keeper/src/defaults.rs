...
use crate::error::LockKeeperError;

fn project_dirs() -> Result<ProjectDirs, LockKeeperError> {
    ProjectDirs::from("", shared::ORGANIZATION, shared::APPLICATION)
        .ok_or(LockKeeperError::ProjectDirs)
}
...
pub mod server {
    ...
    pub fn config_path() -> Result<PathBuf, LockKeeperError> {
